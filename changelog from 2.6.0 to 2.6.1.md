# Updated AE2FluidCraft-Rework (1.2.28-gtnh@Side.BOTH --> 1.2.29-gtnh@Side.BOTH)
...
# Updated Battlegear2 (1.3.7@Side.BOTH --> 1.3.8@Side.BOTH)
...
# Updated Custom-Main-Menu (1.11.2@Side.CLIENT --> 1.11.3@Side.CLIENT)
**Full Changelog**: https://github.com/GTNewHorizons/Custom-Main-Menu/compare/1.11.2...1.11.3

# Updated Electro-Magic-Tools (1.4.6@Side.BOTH --> 1.4.7@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Electro-Magic-Tools/compare/1.4.6...1.4.7

# Updated EnderIO (2.7.4@Side.BOTH --> 2.7.6@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/EnderIO/compare/2.7.4...2.7.6
>## What's Changed
> * Spotless apply for branch tweak-teleport-staff for #158 by @github-actions in https://github.com/GTNewHorizons/EnderIO/pull/159 (2.7.5-pre)
> * Spotless apply for branch tweak-teleport-staff for #158 by @github-actions in https://github.com/GTNewHorizons/EnderIO/pull/161 (2.7.5-pre)
>

# Updated EnderStorage (1.5.1@Side.BOTH --> 1.5.2@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/EnderStorage/compare/1.6.0...1.5.2
...
# Updated GTplusplus (1.11.58@Side.BOTH --> 1.11.63@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/GTplusplus/compare/1.11.58...1.11.63

# Updated Galaxy-Space-GTNH (1.1.83-GTNH@Side.BOTH --> 1.1.84-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Galaxy-Space-GTNH/compare/1.1.83-GTNH...1.1.84-GTNH
>## What's Changed
> * Fix Proteus Glowstone crafting. by @AbdielKavash in https://github.com/GTNewHorizons/Galaxy-Space-GTNH/pull/108 (1.1.84-GTNH)
>

# Updated GoodGenerator (0.8.22@Side.BOTH --> 0.8.24@Side.BOTH)
...
# Updated LogisticsPipes (1.1.5-GTNH@Side.BOTH --> 1.1.14-GTNH@Side.BOTH)
...
# Updated ModularUI (1.1.42@Side.BOTH --> 1.1.43@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ModularUI/compare/1.1.42...1.1.43

# Updated Natura (2.6.1@Side.BOTH --> 2.6.4@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Natura/compare/2.6.1...2.6.4
>## What's Changed
> * Angelica/NotFine leaf render mode support by @jss2a98aj in https://github.com/GTNewHorizons/Natura/pull/19 (2.6.3)
>

# Updated NewHorizonsCoreMod (2.3.50@Side.BOTH --> 2.3.54@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/NewHorizonsCoreMod/compare/2.4.3...2.3.54

# Updated NotEnoughEnergistics (1.5.1@Side.BOTH --> 1.5.2@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/NotEnoughEnergistics/compare/1.5.1...1.5.2

# Updated NotEnoughItems (2.5.27-GTNH@Side.BOTH --> 2.5.28-GTNH@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/NotEnoughItems/compare/2.6.0-GTNH...2.5.28-GTNH

# Updated Realistic-World-Gen (alpha-1.4.1@Side.BOTH --> alpha-1.5.0@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/Realistic-World-Gen/compare/alpha-1.4.1...alpha-1.5.0
>## What's Changed
> * Add ChC support and make TC Magic Forest bigger by @KuroPeach in https://github.com/GTNewHorizons/Realistic-World-Gen/pull/16 (alpha-1.5.0)
>

# Updated ServerUtilities (2.0.35@Side.BOTH --> 2.0.38@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/ServerUtilities/compare/2.0.35...2.0.38
>## What's Changed
> * Fix `/nbtedit block` not saving by @Lyfts in https://github.com/GTNewHorizons/ServerUtilities/pull/70 (2.0.38)
> * [nbtedit] Allow packets larger than 30000 bytes by @sasha0552 in https://github.com/GTNewHorizons/ServerUtilities/pull/69 (2.0.36)
>

# Updated StructureCompat (0.5.0@Side.BOTH --> 0.5.1@Side.BOTH)
**Full Changelog**: https://github.com/GTNewHorizons/StructureCompat/compare/0.5.0...0.5.1

# Updated Tainted-Magic (7.6.4-GTNH@Side.BOTH --> 7.6.8-GTNH@Side.BOTH)
...
# Updated TravellersGearNeo (1.1.0@Side.BOTH --> 1.2.0@Side.BOTH)
